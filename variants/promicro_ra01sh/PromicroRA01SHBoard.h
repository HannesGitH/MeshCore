...
// RA-01SH (SX1262) wiring on nRF52 Pro Micro
// (numbers after "//" are the Arduino pin index / nRF52 port-pin encoding)
#define P_LORA_NSS    7   // P0.11  (11)
#define P_LORA_MOSI   6   // P1.00  (32)
#define P_LORA_MISO   5   // P0.24  (24)
#define P_LORA_SCLK   4   // P0.22  (22)
#define P_LORA_BUSY   3   // P0.20  (20)
#define P_LORA_DIO_1  15  // P0.02  (2)
#define P_LORA_RESET  14  // P1.15  (47)
...
public:
  PromicroRA01SHBoard() : NRF52Board("ProMicro_RA01SH_OTA") {}
  void begin();
